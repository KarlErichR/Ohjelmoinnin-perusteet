from drawLib import drawCircle, drawSquare, saveSvg, drawHexagon, Drawing
    ...
    while True:
        ...
        match choice:
            ...
            case 3:
                ...
                apothem = int(askValue1("Apothem lenght"))
                fill = askValue1("Insert  fill") 
                stroke = askValue1("Insert stroke") 
                drawHexagon(Dwg,middleX, middleY, apothem, fill , stroke)
            case 4:
